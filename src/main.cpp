/*******************************************************************************
 ...
 version:          0.0.1
 vendor:           Grey Newell
 website:          https://musegpt.org
 description:      Chat with an AI model from your audio plugin
...
#else
const String localDevServerAddress = "http://127.0.0.1:8080/";
#endif
